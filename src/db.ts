...
if (plansCount.count === 0) {
  ...
  insertPlan.run('pro', 'Pro', 29, 10, 100, 50, 2);
  insertPlan.run('enterprise', 'Enterprise', 39, 999, 999, 999, 10);
}
...
if (adminCount.count <= 1) {
  ...
  // New requested admin
  try {
    insertAdmin.run('admin-2', 'admin', 'Admin User', 'igotmeforlife04@gmail.com', 'Qqqwwweee11', 'approved');
  } catch (e) {}
